...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td><input type="password" name="newpass" size="30" onkeyup="javascript:hesk_checkPassword(this.value)" autocomplete="off" /></td>
	</tr>
	<tr>
	<td style="text-align:right" width="200"><?php echo $hesklang['confirm_pass']; ?>: </td>
	<td><input type="password" name="newpass2" size="30" autocomplete="off" /></td>
	</tr>
	<tr>
